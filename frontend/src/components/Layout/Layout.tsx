...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const getNavigationItems = () => {
    ...
    switch (user.role) {
      case 'STUDENT':
        return [
          { name: 'Menu', href: '/Student/Menu', icon: HomeIcon },
          { name: 'Cart', href: '/Student/Cart', icon: ShoppingCartIcon },
          { name: 'My Orders', href: '/Student/OrderHistory', icon: ClipboardListIcon },
          { name: 'Track Order', href: '/Student/OrderTracking', icon: ClipboardListIcon },
        ];
      case 'STAFF':
        return [
